...
void loop() {
  ...
  /* wait here until your press the button */  
  while(digitalRead(button)==HIGH) {
    //do nothing
  }

  /* wait 1 sec before moving forward*/  
  delay(1000);
  ...
  /* stop once you press the button */
  stop();

  /* wait 500 ms before you loop back to the beginning.
     if you don't have a delay here, the program may jump
     back to the beginning of the code before you have let go
     of the button, which would cause it to start again inadvertently
  */
  delay(500);
